...
namespace AgendaFullStack.Server.Controllers
{
    ...
    public class ContactosController : ControllerBase
    {
        ...
        {
            // Ordenamos por Nombre antes de convertir a lista
            return await _context.Contactos.OrderBy(c => c.Nombre).ToListAsync();
        }
